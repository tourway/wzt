...
!function (a, b) {
    ...
    a.openWindow = function (b, c, f) {
        ...
        if (window.plus) {
            ...
            return l.autoShow && (h = plus.nativeUI.showWaiting(l.title, l.options)), f = a.extend(f, {id: c, url: b}), j = a.createWindow(f), g = a.showOptions(f.show), g.autoShow && j.addEventListener("loaded", function () {
    ...
    }}), a.addBack({name: "5+", index: 10, handle: function () {
        if (!b.plus)return!1;
